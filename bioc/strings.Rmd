...
transcripts (not genes) is to use the `getTranscriptSeqs` function
from the VariantAnnotation package. This function takes two arguments:
the *GRangesList* of the exons-per-transcript and a *BSgenome* object.
