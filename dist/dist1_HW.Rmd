...
Which is more common: genes becoming significant (smaller $p$) after
controlling for batch with `W1` or less significant?

Estimate the bias for each gene in the mis-specified model. Does this
make sense given the correlation of the batch variable and the
condition?
