...
y=0 line.
3) Finally, instead of median-ratio scaling with `normTransform`, this
time you will perform your own scaling of each column by a factor
correlated with column sum. Calculate: (number of samples) * (column sum)
/ (total sum of all counts) and use this as the correction
factor. Then log2 transform and make an MA plot.
