...
and then compute the sum of scaled counts from those genes:
...
variation present in the scaled counts, associated with sequencing
center. For example, we can run F-tests on each row to find
association of log scaled counts with center. We then plot the log
scaled counts for the gene with the smallest p-value (uncorrected).
